    ...
    <main className="max-w-md mx-auto px-2">
      ...
      <form onSubmit={onSubmit}>
          ...
          <div>
            ...
            <div className="flex w-full justify-center items-center space-x-6">
              <input
                ...
                max="400000000"
                required
                className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-600 focus:bg-white focus:border-slate-600 text-center"
              />
        ...
        <div className="mb-6 ">
          ...
          <p className="text-gray-600 ">The first image will be our cover (max 6)</p>
          <input
            type="file"
            id="images"
            onChange={onChange}
