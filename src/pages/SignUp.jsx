    ...
    <section className="text-3xl text-center mt-6 font-bold">
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          <img
            src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8ZXN0YXRlfGVufDB8fDB8fHww&auto=format&fit=crop&w=400&q=60"
            alt="home"
